...
export class ShipmentUpdateComponent implements OnInit {
  ...
  updateForm(shipment: IShipment): void {
    this.editForm.patchValue({
      id: shipment.id,
      shippedAt: shipment.shippedAt ? shipment.shippedAt.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): IShipment {
    return {
      ...
      shippedAt: this.editForm.get(['shippedAt'])!.value ? moment(this.editForm.get(['shippedAt'])!.value, DATE_TIME_FORMAT) : undefined,
