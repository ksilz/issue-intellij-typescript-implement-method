...
export class ShoppingOrderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.shoppingOrderService
      ...
      .subscribe(
        (res: HttpResponse<IShoppingOrder[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IShoppingOrder[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
