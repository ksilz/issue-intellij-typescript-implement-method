...
export class ShoppingOrderUpdateComponent implements OnInit {
  ...
  updateForm(shoppingOrder: IShoppingOrder): void {
    this.editForm.patchValue({
      ...
      ordered: shoppingOrder.ordered ? shoppingOrder.ordered.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): IShoppingOrder {
    return {
      ...
      ordered: this.editForm.get(['ordered'])!.value ? moment(this.editForm.get(['ordered'])!.value, DATE_TIME_FORMAT) : undefined,
