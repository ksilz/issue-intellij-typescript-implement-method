...
describe('Address e2e test', () => {
  ...
  it('should load Addresses', async () => {
    ...
    expect(await addressComponentsPage.getTitle()).to.eq('simpleShopApp.address.home.title');
  ...
  it('should load create Address page', async () => {
    ...
    expect(await addressUpdatePage.getPageTitle()).to.eq('simpleShopApp.address.home.createOrEditLabel');
  ...
  /* it('should delete last Address', async () => {
        ...
        expect(await addressDeleteDialog.getDialogTitle())
            .to.eq('simpleShopApp.address.delete.question');
