...
describe('ShoppingOrder e2e test', () => {
  ...
  it('should load ShoppingOrders', async () => {
    ...
    expect(await shoppingOrderComponentsPage.getTitle()).to.eq('simpleShopApp.shoppingOrder.home.title');
    await browser.wait(
  ...
  it('should load create ShoppingOrder page', async () => {
    ...
    expect(await shoppingOrderUpdatePage.getPageTitle()).to.eq('simpleShopApp.shoppingOrder.home.createOrEditLabel');
  ...
  /* it('should delete last ShoppingOrder', async () => {
        ...
        expect(await shoppingOrderDeleteDialog.getDialogTitle())
            .to.eq('simpleShopApp.shoppingOrder.delete.question');
