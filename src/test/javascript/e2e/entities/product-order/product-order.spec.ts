...
describe('ProductOrder e2e test', () => {
  ...
  it('should load ProductOrders', async () => {
    ...
    expect(await productOrderComponentsPage.getTitle()).to.eq('simpleShopApp.productOrder.home.title');
    await browser.wait(
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle()).to.eq('simpleShopApp.productOrder.home.createOrEditLabel');
  ...
  /* it('should delete last ProductOrder', async () => {
        ...
        expect(await productOrderDeleteDialog.getDialogTitle())
            .to.eq('simpleShopApp.productOrder.delete.question');
